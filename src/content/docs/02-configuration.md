---
title: "Configuration"
description: "createSisp(config) accepts a single object. Only posId, posAutCode, and database are required; every other key mirrors config/sisp.php from the Laravel..."
sidebar:
  order: 2
---
...
**Next:** [Quick Start](/03-quick-start/)
