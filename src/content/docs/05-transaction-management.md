...
description: "Every update appends a row to sisptransactionlogs with the source (callback, refund, cancel, retry, reconciliation, customer-data, or model), the changed..."
sidebar:
  order: 5
---
