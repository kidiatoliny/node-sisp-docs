---
title: "Handling cancellation"
description: "When the customer clicks Cancel on the gateway card or OTP page, the gateway posts the callback with UserCancelled=true, merchantRef, and merchantSession..."
sidebar:
  order: 7
---
...
**Next:** [Handling failed payments](/examples/fastify/08-failed-payments/)
